...
const FALLBACK: Record<string, AboutData> = {
  th: {
    ...
    heading: ["ทุกช่วงเวลาของชีวิต", "ล้วนกลายเป็นมรดกแห่งความทรงจำ"],
    description:
      "<strong>The Axis Utthayan</strong> เกิดขึ้นจากแนวคิดที่ว่า <em>“บ้านไม่ใช่เพียงสถานที่สำหรับการอยู่อาศัย”</em><br>แต่คือพื้นที่ที่เก็บรักษาเรื่องราว ความสัมพันธ์ และคุณค่าที่จะถูกส่งต่อจากคนรุ่นหนึ่งสู่อีกรุ่นหนึ่ง</p>\n\n<p>ทุกองค์ประกอบของโครงการได้รับการออกแบบอย่างพิถีพิถัน เพื่อรองรับการใช้ชีวิตของครอบครัวยุคใหม่<br>พร้อมสะท้อนรสนิยมอันเหนือกาลเวลา ผ่านสถาปัตยกรรม Modern Classic Monochrome ที่สง่างามในทุกมิต</p>",
  },
  en: {
    image: "/images/about-image.png",
